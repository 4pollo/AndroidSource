package com.boyle.lzoptionsmenu;
		...
		menuGrid.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				case ITEM_FILE_MANAGER:// 文件管理
					System.out.println("ITEM_FILE_MANAGER");
					break;
				case ITEM_DOWN_MANAGER:// 下载管理
					System.out.println("ITEM_DOWN_MANAGER");
					break;
				case ITEM_FULLSCREEN:// 全屏
					System.out.println("ITEM_FULLSCREEN");
					break;
				case ITEM_MORE:// 翻页
					System.out.println("ITEM_MORE");
					if (isMore) {
